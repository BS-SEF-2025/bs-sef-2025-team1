...
import { Assignment, Submission, SubmissionAnswer, Course, Group, User } from '../App';
              ...
              {assignments.length === 0 ? (
                ...
                <div className="space-y-4">
                  {assignments.map(assignment => {
                    ...
                    return (
                      <div key={assignment.id} className={`border-2 rounded-lg p-6 ${
                        isOverdue ? 'border-gray-300 bg-gray-50' : 'border-indigo-300 bg-white'
                      }`}>
